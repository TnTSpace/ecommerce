<script lang="ts">
	...
	import { PointerIcon, MonitorPlayIcon, WorkflowIcon } from 'lucide-svelte';
	...
	onMount(() => {
		...
		const scalabilityData: ChartData<'doughnut'> = {
			...
			datasets: [
				{
					label: 'Jumia Markets',
					data: [2, 7], // Assuming Phoenix Tracker will cover all 9 Jumia markets
			...
			datasets: [
				{
					...
					data: [170000, 3000], // 170,000 - 3,000 = 167,000 USD savings
					backgroundColor: ['#06D6A0', '#FFD166'],
...
<Wrap class="mx-auto bg-jumia-lighter-bg py-8 dark:bg-background md:py-16">
	<header class="mb-16 text-center md:center">
		...
		<p class="mx-auto mt-2 max-w-3xl text-lg">
			A warehouse of AI-powered tools designed to replace expensive third-party licenses, improve
			operational efficiency and significantly cut operational costs.
		</p>
	</header>

	<main class="space-y-20 md:center">
		...
		<section id="problem-solution">
			<div class="mb-12 flex flex-col gap-4 text-center">
				...
				<p class="mx-auto mt-2 max-w-4xl text-muted-foreground">
					While we currently leverage platforms like <Button
						href="https://dataweave.com/"
						target="_blank"
						variant="link"
						class="px-0">Dataweave</Button
					> for competitive pricing, the recurring
					<strong
						>licensing costs are substantial, and the data acquisition can still be inflexible,
						delayed, or sometimes inaccurate for our dynamic campaign needs, hence the quote
					</strong>
				</p>
				<p class="text-center font-semibold italic text-jumia-orange">
					“We have a lot of tools and our pricing is always more expensive.”
				</p>
				<p class="mx-auto mt-2 max-w-4xl text-muted-foreground">
					This directly impacts our "Phoenix Price" leadership during critical campaigns. With the
					integration of <strong>n8n AI and Automation tool</strong>, we can leverage existing
					infrastructure to significantly cut operational costs.
				</p>
			</div>

			<div class="mb-12 flex flex-col gap-4 text-center">
				<h2 class="text-3xl font-bold text-jumia-orange md:text-4xl">
					Enhanced Solution: Phoenix Tracker (Tool #1)
				</h2>
			...
			<div class="grid grid-cols-1 gap-8 md:grid-cols-2">
				...
				<Card class="card text-left">
					...
					<p class="text-muted-foreground">
						Our <strong>self-hosted n8n workflow</strong> automates the scraping of competitor prices
						on a scheduled basis, ensuring we always have the latest Phoenix prices.
					</p>
				</Card>
				<Card class="card text-left">
					<span class="text-5xl">📊</span>
			...
			<div class="mt-8 grid grid-cols-1 gap-4">
				<div class="flex flex-col items-center justify-start gap-2 md:flex-row">
					<h3 class="mb-2 text-xl font-bold">AI Workflow (n8n & Gemini AI)</h3>
					<Button
					...
					<Button
						href="https://drive.google.com/file/d/1Zna1aWqixsWZX9WO4qkGxFaxG2uQHdnL/view?usp=drive_link"
						target="_blank"
					>
						<MonitorPlayIcon />
						<span>Demo NG</span>
					...
					<Button
						href="https://drive.google.com/file/d/1mHe4a5gtAoGuWlgvcqs1tAyFGdszEQoh/view?usp=drive_link"
						target="_blank"
					>
						<MonitorPlayIcon />
						<span>Demo EG</span>
		...
		<section id="detailed-impact" class="flex flex-col gap-4">
			...
			<div class="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
				...
				>
					<h3 class="mb-4 text-left text-xl font-bold">Massive Annual Cost Savings</h3>
				...
				<Card
					class="card grid h-full grid-cols-1 grid-rows-[auto_auto_1fr] bg-white p-4 dark:bg-secondary"
				>
					<h3 class="mb-4 text-left text-xl font-bold">
						Strategic Independence & Pan-African Scalability
					</h3>
					<p class="mx-auto mb-4 max-w-2xl text-left text-muted-foreground">
		...
		<section id="feasibility">
			...
			<div class="mx-auto grid grid-cols-1 gap-6 md:grid-cols-2">
				<Card class="card">
					<h4 class="mb-2 font-bold">What Business Problem is Being Solved?</h4>
					<p class="text-muted-foreground">
				...
				<Card class="card">
					<h4 class="mb-2 font-bold">Who Are the Users?</h4>
					<p class="text-muted-foreground">
				...
				<Card class="card">
					<h4 class="mb-2 font-bold">What Data Will We Require?</h4>
					<p class="text-muted-foreground">
				...
				<Card class="card">
					<h4 class="mb-2 font-bold">How Can We Evaluate Success (Metrics)?</h4>
				...
				<Card class="card md:col-span-2">
					...
					<div class="text-muted-foreground">
						...
						<ul class="mt-2 list-disc pl-5">
							...
							<li>
								<strong>Proven Prototype:</strong> The existing prototypes (n8n workflow) demonstrates
								immediate deployability and impressive results within Jumia's environment.
							</li>
						</ul>
						<p>
			...
			<div class="mt-8 grid grid-cols-1 gap-8">
				...
				<a href="https://n8n.io/pricing/" target="_blank" class="block">
					...
					<p class="mt-2 text-center text-sm text-muted-foreground">
						n8n Self-Hosting ai and automation alternative.
					</p>
				</a>
			</div>
		</section>
		...
		<section id="compelling-story">
			<div class="mb-12 text-center">
				<h2 class="text-3xl font-bold text-jumia-orange md:text-4xl">
					Our Vision: A New Era of Intelligence at Jumia
				</h2>
				<p class="mx-auto mt-2 max-w-2xl text-muted-foreground">
			...
			<div class="grid grid-cols-1 gap-8 md:grid-cols-2">
				<Card class="card md:col-span-2">
					...
					<p class="text-muted-foreground">
						The battle for customers during our campaigns is won and lost on price. By equipping our
						commercial teams with <strong>live, accurate Phoenix prices</strong> at a fraction of
						the current cost, Jumia Analytics Phoenix Tracker ensures we can make rapid, data-driven
						pricing adjustments. This isn't just about efficiency; it's about achieving our sales
						targets, dominating key product categories, and significantly strengthening Jumia's
						competitive edge in the African e-commerce landscape. This allows us to pivot from
						reactive price adjustments to proactive, real-time price leadership,
		...
		<footer class="mt-12 border-t pt-12 text-center">
			...
			<div class="mt-8 flex flex-col items-center justify-center gap-4 md:flex-row">
				<Button
					variant="outline"
					href="https://drive.google.com/drive/folders/1wezADmedqja0qMHpiLegP_cNWSAT2jym?usp=sharing"
					target="_blank"
				>
