...
<Dialog.Root bind:open>
	<Dialog.Content
		class="sm:max-w-[550px] p-0 bg-card/95 backdrop-blur-2xl border-border/40 overflow-hidden rounded-[2.5rem] shadow-2xl"
	>
		<div
		...
		<div class="p-10 space-y-8">
				...
				<div class="grid gap-2">
					...
					<div class="relative">
						...
						<Input
							...
							class="h-12 pl-12 rounded-2xl bg-background/50 border-border/40 focus:ring-primary/20 text-base font-medium shadow-inner"
						/>
					</div>
				</div>
			...
			<div class="flex gap-4 pt-6">
				<Button
					variant="ghost"
					class="flex-1 h-9 rounded-2xl font-bold border-border/40 hover:bg-muted text-muted-foreground"
					onclick={() => (open = false)}
				>
					Cancel
				</Button>
				<Button
					class="flex-1 h-9 rounded-2xl bg-primary shadow-lg shadow-primary/30 hover:shadow-primary/40 transition-all gap-2"
