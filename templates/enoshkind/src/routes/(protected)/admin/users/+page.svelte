	...
	<div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
		...
		<div class="relative w-full md:w-80">
			...
			<Input
				...
				class="pl-10 h-12 bg-card/40 border-border/40 focus:ring-primary/20"
			/>
		</div>
	</div>

	<div
		class="bg-card/40 backdrop-blur-xl border border-border/40 rounded-[2rem] overflow-hidden shadow-2xl"
	>
		<Table.Root>
							...
							<Table.Cell class="text-right px-6">
								<DropdownMenu.Root>
									<DropdownMenu.Trigger
										class="h-8 w-8 hover:bg-primary/10 text-muted-foreground hover:text-primary flex items-center justify-center transition-colors px-0 py-0"
									>
