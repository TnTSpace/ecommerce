...
<Dialog.Root bind:open>
	<Dialog.Content
		class="sm:max-w-[500px] p-0 bg-card/95 backdrop-blur-2xl border-border/40 overflow-hidden rounded-[2rem]"
	>
		...
		<div class="p-8 space-y-6">
			<div class="grid gap-4">
				<div class="grid gap-2">
					...
					<Input
						...
						class="h-11 bg-background/50 border-border/40"
					/>
				</div>
				<div class="grid grid-cols-2 gap-4">
					<div class="grid gap-2">
						...
						<select
							...
							class="h-11 bg-background/50 border-border/40 px-3 text-sm font-medium outline-none"
						>
			...
			<div class="flex gap-3 pt-4">
				<Button
					variant="outline"
					class="flex-1 h-12 font-bold border-border/40"
					onclick={() => (open = false)}>Cancel</Button
				>
				<Button
					class="flex-1 h-12 bg-primary shadow-lg shadow-primary/20"
