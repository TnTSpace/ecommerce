		...
		<Card.Content class="p-8 md:p-10 text-center space-y-6">
			...
			<div class="flex flex-col sm:flex-row gap-3">
				<Input
					...
					class="h-12 text-base px-6 bg-background/50"
					bind:value={waitlistEmail}
				/>
				<Button
					class="h-12 px-8 bg-primary hover:bg-primary/90 font-bold shadow-lg shadow-primary/20"
		...
		<Dialog.Root bind:open={isDetailsOpen}>
			<Dialog.Content class="sm:max-w-[500px] border-primary/20">
				...
				<div class="space-y-6">
					...
					<Button
						class="w-full h-14 bg-primary font-bold text-lg rounded-2xl"
