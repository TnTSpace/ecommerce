...
<div class="space-y-10 w-full max-w-7xl mx-auto pb-12 overflow-hidden">
			...
			<div class="space-y-6 max-w-2xl text-center lg:text-left">
				...
				>
					...
					{#if isAdmin}
						<Button
							variant="outline"
							class="border-white/20 text-white hover:bg-white/10 font-bold rounded-xl"
	...
	<div class="grid grid-cols-2 lg:grid-cols-4 gap-6 p-2">
		...
		>
			...
			<p class="text-[9px] text-muted-foreground capitalize font-bold tracking-widest leading-none">
				Global Members
			</p>
		</div>
		<div
			...
			{#each communities as community}
				...
				>
					<Card.Content class="p-8 space-y-8">
						...
						<div class="pt-6 border-t border-border/20 flex items-center justify-between">
							...
							{#if isMember(community.id)}
								<Button
									variant="outline"
									class="font-bold text-sm capitalize tracking-widest border-primary shadow-sm hover:bg-primary/5 transition-all"
							...
							{:else}
								...
								>
									...
									<Button
										...
										class="font-bold text-sm capitalize tracking-widest shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all rounded-xl"
									>
