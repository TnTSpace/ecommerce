...
<div class="min-h-screen pb-20 max-w-5xl mx-auto px-4 md:px-0">
	...
	<div class="flex items-center justify-between py-8">
		...
		{#if article}
			<Button
				variant="ghost"
				class="h-12 w-12 rounded-2xl text-destructive hover:bg-destructive/10"
	...
	<div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
		...
		<div class="lg:col-span-2 space-y-8">
			<Card.Root
				class="p-8 rounded-[2.5rem] bg-card/40 backdrop-blur-xl border-border/40 shadow-2xl relative overflow-hidden"
			>
				<div class="space-y-8 relative z-10">
					...
					<div class="space-y-4">
						...
						<Input
							...
							class="h-16 text-xl md:text-2xl rounded-3xl bg-background/50 border-border/40 font-bold px-8 focus:ring-primary/20 transition-all shadow-inner"
						/>
					</div>
					...
					<div class="space-y-4">
						...
						>
						<div
							class="rounded-[2.5rem] border-2 border-primary/10 overflow-hidden bg-background/50 min-h-[500px] shadow-sm hover:border-primary/30 transition-all"
						>
		...
		<div class="space-y-8">
			<Card.Root
				class="p-8 rounded-[2.5rem] bg-indigo-950/5 dark:bg-card/40 backdrop-blur-xl border-border/40 space-y-8 shadow-xl"
			>
				<div class="space-y-6">
					<!-- Type & Category -->
					<div class="space-y-3">
						...
						<select
							...
							class="h-14 w-full rounded-2xl bg-background/50 border-border/40 px-6 text-sm font-bold focus:ring-2 focus:ring-primary/20 outline-none transition-all shadow-sm"
						>
					...
					<div class="grid grid-cols-2 gap-4">
						<div class="space-y-3">
							...
							<Input
								...
								placeholder="Mins"
								class="h-14 rounded-2xl bg-background/50 border-border/40 font-bold text-center shadow-sm"
							/>
						</div>
						<div class="space-y-3">
							<Label
					...
					<div class="space-y-3">
						...
						<Input
							...
							class="h-14 rounded-2xl bg-background/50 border-border/40 font-medium px-6 shadow-sm"
						/>
					</div>
				...
				<div class="pt-4 space-y-4">
					...
					<Button
						variant="ghost"
						class="w-full h-14 rounded-2xl font-bold text-muted-foreground border border-border/40 hover:bg-muted"
						onclick={() => goto('/education')}
					>
						Discard Changes
					</Button>
			...
			<!-- Tips Card -->
			<div
				class="p-8 rounded-[2.5rem] bg-emerald-500/5 border border-emerald-500/10 space-y-4 shadow-sm"
			>
				<h5
