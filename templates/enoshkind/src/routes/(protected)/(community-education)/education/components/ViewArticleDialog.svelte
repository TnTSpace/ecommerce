...
<Dialog.Root bind:open>
	<Dialog.Content
		class="sm:max-w-[900px] p-0 bg-background/95 backdrop-blur-2xl border-border/40 overflow-hidden rounded-[2rem] max-h-[90vh] flex flex-col"
	>
		{#if article}
			<!-- Hero / Video Section -->
			<div class="relative shrink-0">
				...
				{:else}
					...
					>
						...
						<div class="text-8xl font-bold text-primary/5 capitalize tracking-tighter select-none">
