...
<Dialog.Root bind:open>
	<Dialog.Content
		class="sm:max-w-[800px] p-0 bg-card/95 backdrop-blur-2xl border-border/40 overflow-hidden rounded-[2rem] max-h-[90vh] flex flex-col"
	>
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
					<div class="md:col-span-2 space-y-2">
						...
						<Input
							...
							class="h-11 rounded-xl bg-background/50 border-border/40 font-medium"
						/>
					</div>
					<div class="space-y-2">
						...
						<select
							...
							class="h-11 w-full rounded-xl bg-background/50 border-border/40 px-3 text-sm font-bold focus:ring-2 focus:ring-primary/20 outline-none"
						>
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
					...
					<div class="space-y-2">
						...
						<Input
							...
							placeholder="e.g. 5"
							class="h-11 rounded-xl bg-background/50 border-border/40 font-bold"
						/>
					</div>
					<div class="space-y-2">
						<Label
		...
		<div class="p-6 md:p-8 shrink-0 bg-background/50 border-t border-border/20 flex gap-3">
			{#if article}
				<Button
					variant="ghost"
					class="h-12 w-12 rounded-xl text-destructive hover:bg-destructive/10"
			...
			<Button
				variant="outline"
				class="flex-1 h-12 rounded-xl border-border/40 font-bold"
				onclick={() => (open = false)}>Cancel</Button
			>
			<Button
				class="flex-[2] h-12 rounded-xl bg-primary shadow-lg shadow-primary/20 font-bold"
