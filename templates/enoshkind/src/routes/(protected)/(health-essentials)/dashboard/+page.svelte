					...
					>
						...
						<div class="grid grid-cols-2 gap-2 mb-8">
							...
							<a
								...
								class="flex items-center gap-2 p-3 bg-white/10 hover:bg-white/20 transition-all text-xs font-bold rounded-xl border border-white/10"
							>
								<ExternalLink class="w-3.5 h-3.5" /> DNA Tests
							</a>
							<a
								href="/diet-tracking"
								class="flex items-center gap-2 p-3 bg-white/10 hover:bg-white/20 transition-all text-xs font-bold rounded-xl border border-white/10"
						...
						<Button
							href="/ai-buddy"
							class="w-full h-14 bg-white text-primary hover:bg-white/90 font-bold shadow-xl shadow-black/20 gap-3"
						>
					...
					>
						...
						<div class="space-y-4">
							<Button
								...
								class="w-full h-14 bg-white/10 hover:bg-white/20 border border-white/10 font-semibold block text-left"
							>
								Update Availability
							</Button>
							<Button
...
<LogDialog bind:open={logOpen} type={logType} />
