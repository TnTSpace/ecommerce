...
<div class="w-full min-h-screen pb-20 bg-linear-to-b from-primary/5 via-background to-background">
	<div class="max-w-7xl mx-auto">
		...
		<div class="mb-10">
			...
			<div class="flex items-center gap-3 mt-6">
				...
				>
				<div
					class="flex items-center gap-2 px-3 py-1.5 bg-card border border-border mt-2 rounded-lg"
				>
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
					<div class="space-y-2">
						...
						<Input
							...
							class="bg-background/50 border-border/50 h-11"
						/>
					</div>
					<div class="space-y-2">
		...
		<Tabs.Root bind:value={activeMonitorTab} class="space-y-10">
			...
			<Tabs.Content value="exercise">
				<div class="space-y-8">
					...
					<div class="bg-card/50 border border-border/50 rounded-2xl p-8 space-y-8">
