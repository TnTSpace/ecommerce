			...
			<div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
				<div class="space-y-4 max-w-3xl">
					...
					<div class="flex flex-wrap items-center gap-4 pt-4">
						<Button
							class="bg-primary hover:bg-primary/90 rounded-2xl h-14 px-8  shadow-lg shadow-primary/20 group"
						...
						<Button
							variant="outline"
							class="rounded-2xl h-14 px-6  border-slate-200 dark:border-slate-700"
							onclick={handleShare}
						>
	...
	<div class="max-w-7xl mx-auto mt-16 sm:mt-24 space-y-16 sm:space-y-24">
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-1 gap-6">
					{#if metrics().length > 0}
						{#each metrics() as metric}
							<div
								class="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm transition-all hover:shadow-2xl hover:border-primary/20 hover:-translate-y-1 duration-300 group"
							>
					...
					{:else}
						<div
							class="bg-white dark:bg-slate-900 p-12 rounded-[2.5rem] border border-dashed border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center text-center space-y-4 col-span-full"
						>
							<div
				...
				<div class="space-y-10">
					...
					<div class="space-y-8">
						{#each recommendations() as rec, i}
							<div
								class="bg-linear-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 p-8 sm:p-10 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group"
							>
								<div
		...
		>
			...
			<div class="relative z-10 flex flex-col xl:flex-row items-center gap-12 sm:gap-16">
				<div
					class="shrink-0 w-24 sm:w-32 h-24 sm:h-32 bg-white/20 backdrop-blur-3xl rounded-[2.5rem] border border-white/30 flex items-center justify-center shadow-inner"
				>
