...
<Dialog.Root bind:open>
	...
	>
				...
				<Popover.Root>
					<Popover.Trigger>
						<Button
							variant="outline"
							class={cn(
								'w-full justify-start text-left font-bold h-12 rounded-xl border-border/40 bg-background/50 px-4',
		...
		<Dialog.Footer class="sm:justify-start">
			<Button
				class="w-full h-14 text-lg font-bold shadow-lg shadow-primary/20 rounded-2xl transition-all active:scale-[0.98]"
				onclick={handleBook}
