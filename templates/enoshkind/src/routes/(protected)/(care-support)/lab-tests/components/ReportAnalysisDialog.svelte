...
<Dialog.Root bind:open>
	<Dialog.Content
		class="max-w-3xl h-[90vh] sm:h-auto overflow-y-auto border-none bg-slate-50 dark:bg-slate-950 p-0 rounded-[2.5rem] shadow-2xl"
	>
		{#if result}
			<div class="relative overflow-hidden">
				...
				<div class="p-6 sm:p-10 space-y-10 relative z-10">
					...
					<!-- Conclusion Message -->
					<div
						class="bg-primary/5 rounded-[2rem] p-8 border border-primary/20 flex flex-col md:flex-row items-center gap-6"
					>
						<div
						...
						<Button
							class="w-full md:w-auto ml-auto bg-primary hover:bg-primary/90 rounded-2xl h-14 px-8 font-bold shadow-lg shadow-primary/20 group"
						>
