...
<div class="min-h-screen flex items-center justify-center p-4">
	<Card.Root
		class="w-full max-w-md rounded-[2.5rem] border-border/40 bg-card/60 backdrop-blur-2xl shadow-2xl p-8 text-center overflow-hidden relative"
	>
				...
				<div class="w-full space-y-3 mt-4">
					{#if status === 'success' && consultationId}
						<Button
							...
							class="w-full py-8 rounded-2xl  shadow-xl bg-emerald-600 hover:bg-emerald-700"
						>
					...
					<Button
						...
						class="w-full py-8 rounded-2xl font-bold "
					>
						Return to Hub
