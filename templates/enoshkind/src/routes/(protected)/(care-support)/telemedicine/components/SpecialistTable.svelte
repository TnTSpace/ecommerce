...
<div
	class="bg-card/40 backdrop-blur-xl border border-border/50 rounded-[2rem] overflow-hidden shadow-xl"
>
	<Table>
		...
		<TableBody>
			...
			{:else}
				{#each doctors as doctor}
					<TableRow class="group border-border/30 hover:bg-primary/5 transition-colors">
						<TableCell>
						...
						<TableCell class="text-right">
							<Button
								size="sm"
								class="rounded-xl font-bold bg-primary hover:bg-primary/90 transition-all opacity-0 group-hover:opacity-100"
