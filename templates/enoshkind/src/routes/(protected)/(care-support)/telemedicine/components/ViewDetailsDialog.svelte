...
<Dialog.Root bind:open>
	<Dialog.Content
		class="sm:max-w-[600px] rounded-[2.5rem] border-border/40 bg-card/60 backdrop-blur-2xl shadow-2xl p-0 overflow-hidden"
	>
		{#if item}
			<div class="p-8 space-y-8">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6">
					<div class="space-y-4 p-6 bg-muted/20 rounded-[2rem] border border-border/40">
					...
					<div class="space-y-4 p-6 bg-primary/5 rounded-[2rem] border border-primary/20">
						<div class="flex items-center gap-3">
							<div
								class="w-8 h-8 rounded-lg bg-background flex items-center justify-center border border-border/40"
							>
