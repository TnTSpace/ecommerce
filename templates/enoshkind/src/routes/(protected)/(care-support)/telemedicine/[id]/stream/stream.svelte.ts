    ...
    if (hasScreenShare) {
      ...
      if (!screenShareContainer) {
        ...
        screenShareContainer.className =
          'group relative overflow-hidden rounded-2xl bg-gray-800 shadow-2xl transition-all hover:shadow-primary/20';
        ...
        overlay.innerHTML = `
          <div class="flex items-center gap-2">
            ...
            <div>
              <p class="font-medium text-white">${this.getParticipantName(participant)}'s screen</p>
              <p class="text-xs text-gray-300">Screen sharing</p>
            </div>
          </div>
        `;
