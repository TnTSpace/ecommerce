							...
							<div class="space-y-3">
								...
								<div class="relative group">
									...
									<Input
										...
										class="pl-12 h-9 border-border/50 bg-muted/20 focus:bg-background transition-all  font-medium"
						...
						<div class="space-y-3">
							...
							<div class="relative group">
								...
								<Input
									...
									class="pl-12 h-9 border-border/50 bg-muted/20 focus:bg-background transition-all text-xl font-bold"
									placeholder="5000"
								/>
							</div>
					...
					<CardContent class="p-0 space-y-8">
						<div class="space-y-3">
							...
							<Combobox
								...
								class="h-9 shadow-sm border-border/50  w-full"
							/>
							{#if fetchingBanks}
							...
							<div class="flex flex-col sm:flex-row gap-4">
								<div class="relative flex-1 group">
									...
									<Input
										...
										maxlength={10}
										class="pl-12 h-9 border-border/50 bg-muted/20 focus:bg-background transition-all text-xl font-bold tracking-[0.2em]"
										placeholder="0123456789"
									/>
								</div>
								<Button
									variant="outline"
									class="h-9 px-8 font-bold bg-background border-primary/20 hover:bg-primary/5 hover:border-primary transition-all shadow-sm"
						...
						<div class="flex justify-between items-center pt-8">
							<Button
								variant="ghost"
								onclick={prevStep}
								class="h-9 px-8 font-bold gap-3 hover:bg-muted transition-all"
							>
					...
					<CardContent class="p-0 space-y-8">
								...
								>
									<div class="flex items-center justify-between">
										...
										<Button
											variant="outline"
											size="sm"
											class="h-10 bg-background border-primary/20 text-primary hover:bg-primary hover:text-white font-bold gap-2 transition-all shadow-sm"
											onclick={() =>
												(form.availability = [
													...form.availability,
											...
											{#if slot.dayOfWeek === i}
												...
												>
													...
													<Button
														variant="ghost"
														size="icon"
														class="h-9 w-full sm:w-14 text-destructive hover:bg-destructive/10 hover:text-destructive transition-all"
														onclick={() =>
						...
						>
							<Button
								variant="ghost"
								onclick={prevStep}
								class="h-9 w-full sm:w-auto px-8 font-bold gap-3 hover:bg-muted transition-all"
							>
								<ArrowLeft class="w-5 h-5" />
								Back
							</Button>
