...
<div class="flex flex-col min-h-screen">
	...
	<section class="py-20 bg-muted/30">
		<div class="container mx-auto px-4 text-center">
			<h1 class="text-4xl md:text-6xl font-bold mb-6 capitalize tracking-tighter">
		...
		<div class="container mx-auto px-4">
			<div class="grid lg:grid-cols-2 gap-16">
				...
				<div in:fly={{ x: -20, duration: 800 }}>
					...
					<div class="space-y-8">
						<div class="flex items-start gap-6 group">
							...
							<div>
								<h3 class="text-xl font-bold mb-1 capitalize tracking-wider">Email Us</h3>
								<a
						...
						<div class="flex items-start gap-6 group">
							...
							<div>
								<h3 class="text-xl font-bold mb-1 capitalize tracking-wider">Call Us</h3>
								<a
						...
						<div class="flex items-start gap-6 group">
							...
							<div>
								<h3 class="text-xl font-bold mb-1 capitalize tracking-wider">Visit Us</h3>
				...
				>
					...
					{#if form?.error}
						<div
							class="mb-6 p-4 rounded-xl bg-destructive/10 text-destructive flex gap-3 text-sm items-center"
							in:fade
						>
						...
						<div class="grid md:grid-cols-2 gap-6">
							<div class="space-y-2">
								...
								<Input
									...
									class="rounded-xl h-12 bg-muted/50 border-transparent focus:bg-background focus:ring-primary"
								/>
							</div>
							<div class="space-y-2">
								<label
