			...
			<Sidebar.Group class="py-1">
				...
				>
					<div class="flex w-full items-center gap-3">
						...
						{/if}
						<span
							class="text-[11px] font-bold uppercase tracking-wider text-muted-foreground/80 group-hover:text-sidebar-foreground"
						>
							{group.groupName}
						</span>
						<ChevronRight
				...
				<Collapsible.Content>
					<Sidebar.Menu class="flex flex-col gap-0.5 pl-[16px]">
