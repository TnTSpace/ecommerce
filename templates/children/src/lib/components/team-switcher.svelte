...
<Sidebar.Menu>
	<Sidebar.MenuItem>
		<a href="/" class="w-full">
			...
			>
				<div
					class="flex aspect-square size-10 items-center justify-center rounded-xl bg-sidebar-primary text-sidebar-primary-foreground shadow-sm group-data-[collapsible=icon]:size-8"
				>
					<activeTeam.logo
