import { generateServiceAgent } from '$lib/ai/agents';
...
export const POST: RequestHandler = async ({ request }) => {
  ...
  // const partialCourse: Partial<iCourse> = {
  //   name: 'Business and Management Progression Route (Level 6)',
  //   title: 'BA (Hons)',
  //   description: `Ready to become the skilled, aware and conscious business professional that
  ...
  //   content: `On this Level 6 top-up degree course, you will further develop your understanding of the theory and practice of modern business. 
  //     Throughout the course, you will have the opportunities and support needed to develop the core skills you need to excel in business.
  ...
  // }
  const result = await generateServiceAgent(servicename)
