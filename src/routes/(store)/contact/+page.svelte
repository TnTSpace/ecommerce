  ...
  const handleSubmit = (e: SubmitEvent) => {
    ...
    setTimeout(() => {
      ...
      toast.success("Message sent successfully!", {
        description: "One of our representatives will get back to you shortly.",
        position: "top-center",
      });
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        <Card class="border-border/50 bg-card/30 backdrop-blur-sm">
          <CardContent class="p-6">
            ...
            <p class="text-sm font-bold">123 Commerce Avenue, Lagos, Nigeria</p>
          </CardContent>
        </Card>
      ...
      <Card class="border-border shadow-lg rounded-xl">
        <CardContent class="p-8 md:p-10">
          <form onsubmit={handleSubmit} class="space-y-6">
            ...
            <Button
              type="submit"
              class="w-full h-12 font-bold text-base rounded-lg shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
